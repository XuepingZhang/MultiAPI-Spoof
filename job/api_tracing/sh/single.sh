...
export LD_LIBRARY_PATH=/work/xz464/anaconda3/envs/Antispoofing/lib:$LD_LIBRARY_PATH
...
APP="python -u /work/xz464/zxp/new_dataset_experiment_dkucc/aasist-main/main_api1.py --dist-url tcp://${1}:33666 \
    ...
    --outfile /work/xz464/zxp/new_dataset_experiment_dkucc/aasist-main/job/api_tracing/log/api_tracing.out "
case ${lrank} in
0)
