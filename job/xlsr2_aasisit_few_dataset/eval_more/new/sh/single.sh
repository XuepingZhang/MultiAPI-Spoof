...
echo disturl is tcp://${1}:33666



APP="python -u /dkucc/home/xz464/zxp/new_dataset_experiment_dkucc/aasist-main/main_whisper_lora1.py --dist-url tcp://${1}:33666 \
    --dist-backend nccl --world-size=${comm_size} --rank=${comm_rank} --local-rank=${lrank}\
    --config /dkucc/home/xz464/zxp/new_dataset_experiment_dkucc/aasist-main/job/whisper_aasist_with_new/eval_more/new/eval_new.conf \
    --outfile /dkucc/home/xz464/zxp/new_dataset_experiment_dkucc/aasist-main/job/whisper_aasist_with_new/eval_more/new/log/whisper_aasist_with_new.out\
    --eval"
